...
do
    ...
    montage damping/oscillations*$i*png -tile 4x4 -geometry +0+0 damping/${i}_oscillations_all.png
done

convert damping/*_damping_all.png damping/damping_all.pdf
convert damping/*_oscillations_all.png damping/oscillations_all.pdf
